...
import com.example.demo.databinding.FunHeaderVhBinding
...
class FunHeaderVH(vg: ViewGroup) : BaseRvVH<FunHeaderVhBinding, FunItemVM>(ViewTools.inflate(R.layout.fun_header_vh, vg)) {
